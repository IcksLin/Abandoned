/*********************************************************************************************************************
* 文件名称          my_pid
* 功能说明          PID、方向 PD 与电机 LADRC 封装控制器
* 适用平台          LS2K0300
* 修改记录
* 日期              作者                        备注
...
/**
 * @brief 方向 PD 控制器
 * @details 用于将视觉方向偏差或角度偏差转换为转向控制量，包含分段比例项、非线性比例项和微分项。
 */
class PDController {
private:
    // PID 参数
...
#include "LADRC.hpp"
/**
 * @brief 面向电机速度环的 LADRC 封装
 * @details 将 LADRC 输出限制在 PWM 范围内，并保存最近一次速度误差和控制输出，便于调参观察。
 */
