...
void hight_frequence_encoder_get_speed_handler(){
    static uint64_t Ti_tick = 0,target_speed_test = 0;

    lardc_get_speed(1,1024,0.035,0.001, &left_speed,&right_speed);
    // motor_set_speed_ladrc(speed_to_pwm_l, 0);
    ...
    if(onto_pd_control_enable==1){
        ...
        speed_to_pwm_r = (int16_t)ladrc_right.calculatePWM(-target_speed_l, right_speed);
        ladrc_left.ladrc.getTrackerOutput(ladrc_left.v1_td,ladrc_left.v2_td);
        ladrc_left.ladrc.getObserverOutput(ladrc_left.z1_eso,ladrc_left.z2_eso,ladrc_left.z3_eso);

        ladrc_right.ladrc.getTrackerOutput(ladrc_right.v1_td,ladrc_right.v2_td);
        ladrc_right.ladrc.getObserverOutput(ladrc_right.z1_eso,ladrc_right.z2_eso,ladrc_right.z3_eso);
